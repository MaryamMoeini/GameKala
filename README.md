...
As the necessity of any web application, I have created a JUnit test `KalahApplicationTests.java` which will test the first move if the player one click on index 0.
